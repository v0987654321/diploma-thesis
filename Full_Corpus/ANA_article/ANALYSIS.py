...
# ARTICLE WORKFLOW PROVENANCE
# This ANA_article workflow reads CORPUS_article/data/review_master.csv.
# That review master contains Final_* coding variables constructed from the
# Gemini conservative adjudicated layer with pipeline fallback. The original
# pipeline values are preserved as Pipeline_* columns for audit purposes.
...
CORPUS_DIR = ROOT_DIR / "CORPUS_article"
