...
OUTPUT_PARSE_ERRORS_CSV = "data/gemini_parse_errors.csv"

OUTPUT_FINAL_WORKING_CSV = "data/final_llm_coding_working.csv"
OUTPUT_MERGE_ISSUES_CSV = "data/final_llm_merge_issues.csv"
...
OUTPUT_MANUAL_VERIFY_CSV = "data/final_manual_verification_table.csv"
...
def main():
    ...
    if not df_raw.empty:
        ...
        print(f"\nStep13: selecting best raw record from {total_groups} grouped article_ids")
    ...
    print(f"\nStep13: parsing {total} selected raw output records")
